...
%token LPAR RPAR TRUE FALSE BOOL INT STAR COMMA DDOTS ARROW ECHO FUN REC LBRACK RBRACK CONST SEMICOL SET PROC VAR IF_STAT WHILE CALL
...
%%
  ...
  | PROC IDENT LBRACK args RBRACK block               {ASTProc($2,$4,$6)}
  | PROC REC IDENT LBRACK args RBRACK block           {ASTProcRec($3,$5,$7)}
